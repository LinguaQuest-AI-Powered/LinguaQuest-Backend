...
public class AuthService {
    ...
    public RegisterResponseDto register(RegisterRequestDto registerRequestDto) {
        ...
        User user = User.builder().username(registerRequestDto.username()).email(registerRequestDto.email()).isVerified(false).password(passwordEncoder.encode(registerRequestDto.password())).nativeLanguage(registerRequestDto.nativeLanguage()).targetLanguages(targetLanguageSet).build();
