...
import gov.jets.iti.LinguaQuest.service.MailService;
...
public abstract class AbstractMailService implements MailService {
    ...
    protected MimeMessage buildOtpMimeMessage(MimeMessage existingMessage, String email, String otp) throws MessagingException {
        MimeMessage message = (existingMessage != null) 
                ? existingMessage 
        ...
        helper.addInline("lingoImage", new ClassPathResource("images/lingo_mail.png"));
